...
<div class="vc_page_welcome">
  <div class="vc_page_welcome_wrap">
    ...
    </ul><a class="ui_kit_button vc_page_button" href="/vacancies">@lang('@lang('Смотреть все вакансии')')</a>
  </div>
</div>
...
<div class="vc_page_join">
  <div class="vc_page_wrap">
    <div class="vc_page_join_block">
      ...
      <p>Мы создаем не только пространства для наших клиентов, но и возможности для наших сотрудников расти, развиваться и достигать новых карьерных высот.</p><a class="ui_kit_button vc_page_button" href="/vacancies">@lang('@lang('Смотреть все вакансии')')</a>
    </div>
  </div>
</div>
