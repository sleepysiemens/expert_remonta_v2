<div class="vc_page_contact" id="vc_page_contact">
  <div class="vc_page_wrap">
    <div class="vc_page_heading ui_kit_h1_heading">Оставьте свои контакты,<br> чтобы стать частью <br> нашей команды</div>
    <form action="{{route('resume.store')}}" method="POST" enctype='multipart/form-data'> 
      ...
      <div class="vc_page_input">
        <input class="ui_kit_input" name="fio" type="text" required placeholder="ФИО"/>
      </div>
      <div class="vc_page_input">
      ...
      <div class="vc_page_input">
        <label class="ui_kit_input" for="file">Прикрепить резюме</label>
      ...
      <button class="ui_kit_button vc_page_button">Отправить</button>
    </form>
  </div>
</div>