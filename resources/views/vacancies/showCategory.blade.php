...
@section('seo-title')
  {{app()->db_translate($vacancyCategory->seo_title_ru, $vacancyCategory->seo_title_kz)}}
@endsection

@section('meta-description')
    {{app()->db_translate($vacancyCategory->meta_desc_ru, $vacancyCategory->meta_desc_kz)}}
@endsection
...
<div class="vacancies_page vacancy_category">
  ...
  <div class="vacancies_page_wrap">
    <h1 class="vacancies_page_heading ui_kit_h1_heading">Вакансии в категории {{app()->db_translate($vacancyCategory->name, $vacancyCategory->name_kz)}}</h1>
